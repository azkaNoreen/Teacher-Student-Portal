    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String[] coursedep=cd.getText().toString().split(" ",2);

                String courseCode=coursedep[0].charAt(0)+""+coursedep[1].charAt(0)+""+cy.getText().toString();
                Course courseAdded=new Course(cn.getText().toString(),cd.getText().toString(),ct.getText().toString(),cy.getText().toString(),courseCode);
